/**
 * 1. Compile using: tsc --target es2015 paa-example-with-async-advanced.ts
 * 2. Execute using: node paa-example-with-async-advanced.js
 * 3. More examples / documentation on https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function
 */
